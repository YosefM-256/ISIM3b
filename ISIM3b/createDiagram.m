function circuitPanel = createDiagram(fig) 
    ...
    circuitDiagram.Ictext = annotation(circuitPanel,"textbox",'Units','Pixels','Position',[285 110 20 10] ...
    ...
    circuitDiagram.Vbetext = annotation(circuitPanel,"textbox",'Units','Pixels','Position',[40 150 100 10] ...
        ...
        ,"FontSize",8,'Color','red');
    circuitDiagram.Ie = annotation(circuitPanel,"arrow",'Units','Pixels','Position',[285 50 0 -30]);
    circuitDiagram.Ietext = annotation(circuitPanel,"textbox",'Units','Pixels','Position',[290 40 100 10] ...
        ,'String',"Vbe = -","HorizontalAlignment","left","VerticalAlignment","middle","EdgeColor",'none' ...
        ,"FontSize",8);
